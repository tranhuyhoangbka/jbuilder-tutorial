...
10.times do
  article = Article.create(name: Faker::Name.title, content: Faker::Lorem.sentence, author: Author.all.sample)
  2.times{article.comments.create content: Faker::Lorem.sentence, author: Author.all.sample}
end
